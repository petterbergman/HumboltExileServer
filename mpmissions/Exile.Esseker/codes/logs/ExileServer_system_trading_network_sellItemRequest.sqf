...
try 
{
	...
	_traderLog = format ["PLAYER: %1:%6 SOLD ITEM: %5 FOR %2 POPTABS AND %3 RESPECT | PLAYER TOTAL MONEY: %4 RESPECT: %7",_playerObject,_sellPrice,_respectGain,_playerMoney,_itemClassName,(getPlayerUID _playerObject),_playerRespect];
    'ARMA_LOG' callExtension format['Exile_Esseker_A3_TRADERLOG:%1',_traderLog];
