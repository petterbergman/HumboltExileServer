...
try 
{
	...
	if (_mode isEqualTo 0) then
	{
		...
		'ARMA_LOG' callExtension format['Exile_Esseker_A3_TERRITORYLOG:%1',_TerritoryPOPTABLog];
	}
	else 
	{
		...
		'ARMA_LOG' callExtension format['Exile_Esseker_A3_TERRITORYLOG:%1',_TerritoryRESPECTLog];
	};
