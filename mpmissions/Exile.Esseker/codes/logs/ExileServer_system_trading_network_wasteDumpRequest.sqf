...
try 
{
	...
	_recycleLog = format ["PLAYER: %1:%7 RECYCLED ITEM: %5 WITH %6 CARGO FOR %2 POPTABS AND %3 RESPECT | PLAYER TOTAL MONEY: %4 RESPECT %8",_playerObject,_revenue,_respectGain,_playerMoney,_vehicleObject,_cargo,(getPlayerUID _playerObject),_playerRespect];
    'ARMA_LOG' callExtension format['Exile_Esseker_A3_RECYCLELOG:%1',_recycleLog];
}
catch
{
