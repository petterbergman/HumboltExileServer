...
_servicePointClasses = ["O_Truck_03_covered_F","Land_CarService_F","Land_fs_roof_F","CargoNet_01_barrels_F","Land_FuelStation_Feed_F"]; // service point classes (can be house, vehicle and unit classes)
...
_NoGoWeapCName = [
		...
		"missiles_DAR",
		// GH Weapons
		"LMG_Minigun_Transport2","LMG_Minigun_Transport",
		// Chinook Weapons
		"mas_M134_minigun","M134_minigun","mas_M134_minigun_2","Laserdesignator_mounted","Laserdesignator_mounted_2",
		//GH Flare
		"CMFlareLauncher"
]; 
...
_NoGoAmmoCName = [ 
		...
		//chinook ammo
		"B_762x51_Minigun_Tracer_Yellow_splash","B_762x51_Minigun_Tracer_Red_splash",
		//GH 200 RND
